...
Endpoint: GET /connect/v2/contracts/studios
Version: 1.0.0
...
## Response 200 fields (*/*):
  ...
  - `studioPublicDto` (object)

  - `studioPublicDto.city` (string)

  - `studioPublicDto.description` (string)

  - `studioPublicDto.email` (string)

  - `studioPublicDto.houseNumber` (string)

  - `studioPublicDto.logo` (object)

  - `studioPublicDto.logo.bucketName` (string, required)

  - `studioPublicDto.logo.id` (integer)

  - `studioPublicDto.logo.objectKey` (string, required)

  - `studioPublicDto.logo.url` (string)

  - `studioPublicDto.name` (string)

  - `studioPublicDto.province` (string)

  - `studioPublicDto.provinceCode` (string)

  - `studioPublicDto.street` (string)

  - `studioPublicDto.telephone` (string)

  - `studioPublicDto.website` (string)

  - `studioPublicDto.zip` (string)
