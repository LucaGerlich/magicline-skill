...
Endpoint: GET /connect/v2/studio/details/{studioId}
Version: 1.0.0
...
## Response 200 fields (*/*):
  ...
  - `centralLegalLinks` (array)
    Legal Links configured on the Operating Company currently active on the Studio

  - `centralLegalLinks.centralLegalLinkDocumentType` (string)
    Enum: "IMPRINT", "PRIVACY", "TERMS_AND_CONDITIONS", "REVOCATION"

  - `centralLegalLinks.content` (string)

  - `centralLegalLinks.contents` (array)

  - `centralLegalLinks.contents.locale` (string)

  - `centralLegalLinks.contents.value` (string)

  - `centralLegalLinks.databaseId` (integer)

  - `centralLegalLinks.legalLinkType` (string)
    Enum: "EXTERNAL_URL", "TEXT"

  - `centralLegalLinks.legalLinkTypes` (array)

  - `centralLegalLinks.legalOrganizationUnitId` (integer)

  - `centralLegalLinks.optlock` (integer)
