...
Endpoint: GET /connect/v1/terminal/customer-data-by-codicefiscale
Version: 1.0.0
...
## Response 200 fields (*/*):
  ...
  - `birthInformationDto` (object, required)
    Date, place and country of birth of customer

  - `birthInformationDto.countryOfBirth` (string)
  ...
  - `birthInformationDto.dateOfBirth` (string)

  - `birthInformationDto.placeOfBirth` (string)

  - `codiceFiscale` (string, required)
    Codice fiscale of customer
